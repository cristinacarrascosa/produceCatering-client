...
@Component({
  selector: 'app-servicio-new-user-routed',
  templateUrl: './servicio-new-user-routed.component.html',
  styleUrls: ['./servicio-new-user-routed.component.css']
})
export class ServicioNewUserRoutedComponent implements OnInit {
...
fechahora: Date;
  ...
  showModal = () => {
    ...
    myModalEl.addEventListener('hidden.bs.modal', (event): void => {
      this.oRouter.navigate(['/user/servicio/plist'])
    })
    this.myModal.show()
  }
